                ...
                <br><br>
                    ...
                    <td> 
                        <div class="project-actions-2">
                            <a href="dshTaskMilestone?user_id=<?php echo $row['user_id'];?>&&pid=<?php echo $row['proj_id'];?>&&task_id=<?php echo $row['t_id'];?>&&task_name=<?php echo $row['task_name'];?>" title="Record Task Milestone"><i class="fa fa-pie-chart fa-1x"></i> Assign Milestone</a>
                        </div>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
