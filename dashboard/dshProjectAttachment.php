                                            ...
                                            foreach($projectContainer as $images){
                                                echo '<div class="img-host">
                                                    ...
                                                    <div class="img-host-btns">
                                                        ...
                                                        <a href="../handlers/_deleteProjectPicture?a_id='.$images["a_id"].'&&proj_id='.$images["proj_id"].'&&f_name='.$images["file_name"].'&&user_id='.$images["user_id"].'&&pid='.$images["proj_id"].'"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </div>';
                                            }
                                        }else {
