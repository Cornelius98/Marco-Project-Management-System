                ...
                <br><br>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="left">Add Task Milestone</h2></strong>
                            </div>
                            <div class="card-body">
                    ...
                    <td> 
                        <div class="project-actions-2">
                            <a href="dshTaskMilestone?user_id=<?php echo $row['user_id'];?>&&pid=<?php echo $row['proj_id'];?>&&task_id=<?php echo $row['t_id'];?>&&task_name=<?php echo $row['task_name'];?>" title="Record Task Milestone"><i class="fa fa-pie-chart fa-1x"></i> Add Milestone To Task</a>
                        </div>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
