                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="left">Join Project Discussions</h2></strong>
                            </div>
                            <div class="card-body">
                    ...
                    <td> 
                        <div class="project-actions-2">
                            <a href="dshProjectDiscussion?user_id=<?php echo $row['user_id'];?>&&pid=<?php echo $row['proj_id'];?>" title="Project Progress Record"><i class="fa fa-users fa-1x"></i> Join</a>
                        </div>
                    </tr>
                    <?php 
                    $cnt=$cnt+1;
