<?php
    ...
    include('../h_files.php');
    $o = $ProjectOperations->statistics($_SESSION["adminTypeId"]);
?>
<!doctype html>
                ...
                <div class="animated fadeIn">
                                ...
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            ...
                                            <span class="count"><?php echo $o["projects"]["total_projects"];?></span>
                                        </h3>
                                        <p class="text-light mt-1 m-0">PROJECTS</p>
                                    </div>
                            ...
                            <div class="card text-white bg-flat-color-3">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        ...
                                        <p class="text-light mt-1 m-0">TASKS</p>
                                    </div>
                                    <div class="card-right float-right text-right">
                            ...
                            <div class="card text-white bg-flat-color-5">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        ...
                                        <p class="text-light mt-1 m-0">Milestones</p>
                                    </div>
                            ...
                            <div class="card text-white bg-flat-color-6">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            <span class="currency float-left mr-1"></span>
                                            <span class="count"><?php echo $o["attachments"]["total_attachments"];?></span>
                                        </h3>
                                        <p class="text-light mt-1 m-0">Attachments</p>
                                    </div>
                            ...
                            <div class="card text-white bg-flat-color-7">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            <span class="currency float-left mr-1"></span>
                                            <span class="count"><?php echo $o["filesharing"]["total_filesharing"];?></span>
                                        </h3>
                                        <p class="text-light mt-1 m-0">Files Shared</p>
                                    </div>
                                    <div class="card-right float-right text-right">
                            ...
                            <div class="card text-white bg-flat-color-8">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            <span class="currency float-left mr-1"></span>
                                            <span class="count"><?php echo $o["discussions"]["total_discussions"];?></span>
                                        </h3>
                                        <p class="text-light mt-1 m-0">Discussions</p>
                                    </div>
                            ...
                            <div class="card text-white bg-flat-color-6">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        ...
                                        <p class="text-light mt-1 m-0"><a href="dshCreateProject">Create Project</a></p>
                                    </div>
                                    <div class="card-right float-right text-right">
                            ...
                            <div class="card text-white bg-flat-color-4">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        ...
                                        <p class="text-light mt-1 m-0"><a href="dshShowProjects">Show</a></p>
                                    </div>
                            ...
                            <div class="card text-white bg-flat-color-2">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        <h3 class="mb-0 fw-r">
                                            <span class="currency float-left mr-1"></span>
                                            <span class="count">Discuss</span>
                                        </h3>
                                        <p class="text-light mt-1 m-0"><a href="dshShowProjectsForDiscussion">Join</a></p>
                                    </div>
                                    <div class="card-right float-right text-right">
                            ...
                            <div class="card text-white bg-danger">
                                <div class="card-body">
                                    <div class="card-left pt-1 float-left">
                                        ...
                                        <p class="text-light mt-1 m-0"><a href="dshShowProjectsForDiscussed">Rejoin</a></p>
                                    </div>
                                    <div class="card-right float-right text-right">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h3 align="center"><marquee direction="left" style="text-transform:capitalize;">Current Session: <?php echo $_SESSION["firstName"]." ".$_SESSION["lastName"];?></marquee></h3>
                                </div>
                            </div>
                            </div>
                            </div>
