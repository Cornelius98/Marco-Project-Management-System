                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="start">Edit Your Project</h2></strong>
                            </div>
                            <div class="card-body">
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Edit Name</label>
                                                        <input id="pj_name" name="pj_name" type="text" class="form-control cc-exp" value="<?php echo $projectContainer["proj_name"];?>" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a project name" placeholder="Edit Name">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <label for="x_card_code" class="control-label mb-1">Edit Description</label>
                                                    <input id="pj_desc" name="pj_desc" type="text" class="form-control cc-cvc" value="<?php echo $projectContainer["description"];?>" Required data-val="true" data-val-required="Please enter a project description" data-val-cc-cvc="Please enter a project description" placeholder="Edit Description">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Edit Start Date</label>
                                                        <input id="pj_sdate" name="pj_sdate" type="date" class="form-control cc-exp" value="<?php echo $projectContainer["start_date"];?>" data-val="true" data-val-required="Please pick project start date" data-val-cc-exp="Please pick project start date" placeholder="Edit Start Date">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Edit Finishing Date</label>
                                                        <input id="pj_edate" name="pj_edate" type="date" class="form-control cc-exp" value="<?php echo $projectContainer["end_date"];?>" data-val="true" data-val-required="Please pick project start date" data-val-cc-exp="Please pick project end date" placeholder="Edit End Date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="proj_id" id="proj_id" value="<?php echo $projectContainer["proj_id"];?>" />
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" name="submit" id="submitForm" class="btn btn-success">Apply Project Edits</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
        ...
        let formData = new FormData(),
            ...
            $.ajax({
                ...
                success:function(q,status,settings){
                    ...
                    if(s["status"]==200){
                        $(".error-display").html('<div class="e-success">Project Edits Applied Successfully</div>');
