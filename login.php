...
if(isset($_POST['login'])){
    ...
    if($result->num_rows > 0 && password_verify($password,$row["password"])){
        ...
        if($row['role'] == 1){
            ...
            $errorMsg = "<div class='alert alert-danger' role='alert'>This Login Is Restricted To Users, You're Attempting To Access An Administrator Account</div>";
        }
                ...
                <div class="login-form cooler-login-forms">
                    <form method="post" action="">
                            ...
                            <div class="init text-center cool-forms">
                               <strong><h2 align="center">Sign in!</h2></strong>
                               <br>
